...
def topKItems(prefer, user, itemId, k=20, sim = sim_cosine):
	itemSet = []
	scores = []
	items = []
...
def getAllUserRating(fileTrain, fileTest, fileResult, k=40, similarity=sim_pearson_item):
