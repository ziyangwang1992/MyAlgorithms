...
def getAllUserRating(fileTrain, fileTest, fileResult, k=15, similarity=sim_cosine):
...
if __name__ == "__main__":
    ...
    while num <= 0:
        ...
        num+=1
    tkMessageBox.showinfo(title='Hello', message='Your cf_item_cosine has been run successfully')
